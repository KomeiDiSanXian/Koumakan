...
func (e *ZeroEngine) GetLazyData(filename string, isDataMustEqual bool) ([]byte, error) {
	if e.datafolder == "" {
...
func (e *ZeroEngine) GetCustomLazyData(dataurl, filename string) ([]byte, error) {
	if e.datafolder == "" {
		return nil, errors.New("datafolder is empty")
	}
...
func (e *ZeroEngine) InitWhenNoError(errfun func() error, do func()) {
	err := errfun()
	if err != nil {
